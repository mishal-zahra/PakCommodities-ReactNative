...
export const Register = ({navigation}) => <Navbar navigation={navigation} name ="Subscribe" />
...
export const Spices = ({navigation}) => <Navbar navigation={navigation} name ="Spices" />
export const Sugar = ({navigation}) => <Navbar navigation={navigation} name ="Sugar/Gur" />
export const Oilseeds = ({navigation}) => <Navbar navigation={navigation} name ="Oil Seeds" />
